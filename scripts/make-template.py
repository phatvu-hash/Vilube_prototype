...
NOTES = {
    ...
    "MA_KIEN_DAU": "Mã kiện đầu tiên, app tự tăng dần. Kho BB cần 7 chữ số (0008083), kho NVL là DrumID (DR0000001) — không chứa dấu /",
    "SO_LO": "Bắt buộc với dòng kho NVL có phuy dán tem: tem phuy là MãHàng/SốLô/SốLượng/MãPhuy",
